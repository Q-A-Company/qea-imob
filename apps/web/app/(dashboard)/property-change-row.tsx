  ...
  return (
    <li className="flex flex-wrap items-center justify-between gap-3 py-1.5 text-xs">
      <span className="flex items-center gap-2">
        ...
        <span className="rounded bg-background px-1.5 py-0.5 text-[10px] font-medium text-muted">
      ...
      {change.changeType === "price" ? (
        ...
        <span className="font-mono font-semibold text-signal-text">{formatBRL(change.newPrice)}</span>
      ) : (
        <span className="text-muted">—</span>
      )}
    </li>
